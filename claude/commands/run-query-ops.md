Use the coo agent to operationalize query generation, review, and optimization for: $ARGUMENTS

Then route execution to the query-ops agent.
...
- escalate architectural or pipeline implications to the architect agent
- summarize the recommended final query set, open risks, and next operator action
